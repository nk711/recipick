...
public class Recipe {
    ...
    public Recipe(String name, String description, HashMap<Ingredients, String> ingredients, String preparation, int duration, int calories, double budget, int servings, Cuisine cuisine, ArrayList<String> images, boolean share) {
        this.name = name;
